...
const TILES: TileItem[] = [
  ...
  },
  {
    label: 'Adquirentes',
    sigla: 'AQ',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><circle cx="17" cy="15" r="2"/></svg>`,
    rota: '/erp/adquirentes'
  },
  {
    label: 'Entregas — Faixas e Regras',
    sigla: 'EF',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M13 16V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h1"/><path d="M14 17h4l3-3v-3l-3-3h-4"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/></svg>`,
    rota: '/erp/entregas-config'
  },
  {
    label: 'Feriados',
    sigla: 'FD',
